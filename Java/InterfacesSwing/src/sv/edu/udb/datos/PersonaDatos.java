...
public class PersonaDatos {
    private final String SQL_INSERT
            = "INSERT INTO persona(id_persona,nombre,edad,telefono,sexo,id_ocupacion,fecha_nac) VALUES(?,?,?,?,?,?,?)";
    private final String SQL_UPDATE
            = "UPDATE persona SET nombre=?, edad=?,telefono=?, sexo=?, id_ocupacion=?, fecha_nac=? WHERE id_persona=?";
    private final String SQL_DELETE
            = "DELETE FROM persona WHERE id_persona = ?";
    private final String SQL_SELECT
            = "SELECT p.id_persona,p.nombre , p.edad,p.telefono ," + "p.sexo, o.ocupacion, p.fecha_nac " + "FROM persona p INNER JOIN ocupaciones o ON p.id_ocupacion = o.id_ocupacion ";
